...
import Clan from '../api/clanes/clanes.model';
      ...
      Clan.find({}).remove()
        .then(() => {
          Promise.all([
            ...
            .then(() => {
              console.log('finished populating clanes');
            });
          });
        });
    });
